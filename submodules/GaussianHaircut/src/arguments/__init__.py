...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.use_barf = False
        self.flame_mesh_dir = ""
        self.strand_scale = 2e-3 #1e-4 for 30k
        # Visualization args
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.lambda_dmask = 0.0
        self.lambda_dorient = 0.0
        self.lambda_dsds = 0.0
        self.lambda_sdf = 0.0
        self.lambda_normal = 0.0
        self.lambda_vol = 0.0
        self.lambda_chamfer = 0.0
        self.lambda_length_uniform = 0.0
        self.lambda_length_const = 0.0
        self.lambda_curv = 0.0
        self.lambda_shape_consist = 0.0
        self.lambda_knn_smooth = 0.0
        self.knn_smooth = 10
        self.lambda_knn_shape_consist = 0.0
        self.lambda_gravity_consist = 0.0
