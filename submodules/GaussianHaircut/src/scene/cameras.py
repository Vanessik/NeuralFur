...
from utils.graphics_utils import getWorld2View2, getProjectionMatrix, fov2focal, getProjectionMatrixShift
...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, cx, cy,
                 width, height,
                 image, mask_body, mask_hair, mask_bald, orient_angle, orient_conf, depth,
                 image_name, uid,
        ...
        self.original_mask = torch.cat([mask_hair, mask_body, mask_bald], dim=0)
